...
if INP=='99':
     ...
     if TYPE=='1':
          FILE_CONTENT= f'''@echo off
                            ...
                            echo {'-+'*(len(MSG)//2+1)}
                            pause '''
     write(file=f'C:/Users/{os.getlogin()}/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Startup/{TITLE}.bat',text=FILE_CONTENT)
elif INP=='12':
    CFAR= subprocess.getoutput('net session')
    if CFAR!='There are no entries in the list.\n':
