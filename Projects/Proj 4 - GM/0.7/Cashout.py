...
def St_CshotCrdt():
    ...
    if Credit < 50000:
        ...
        CnCshot= Credit - RmnnVluCshot
        if RmnnVluCshot <= 0:
            print('You can Cashout ' + str(Credit))
        ...
        if RmnnVluCshot > 0:
            print('You can Cashout ' + str(CnCshot))
            CrdtVlu_Cshot= input('Type how much are you going to cashout? ')
            try:
                CrdtVlu_Cshot= float(CrdtVlu_Cshot)
                CrdtVlu_Cshot= int(CrdtVlu_Cshot)
                if CrdtVlu_Cshot > CnCshot:
                    print('You can only cashout ' + str(CnCshot) + '\nRead HELP for more information.')
                    St_CshotCrdt()
                else:
                    if CrdtVlu_Cshot < 50000:
                        print('At least you need 50000$ to cashout.')
