...
FEATURES:
 ...
 - clr() :                               function to clear the console and terminal.
...
- CLASS File:
                                         ...
                                         1- read(file_path) :         return content of the file
                                         2- write(file_path) :        write things you want in file you want. (Read Help)
                                         3- exists(path) :            return True if file exists. else False.
                                         4- copy(src,dst) :           copy file from src to dst
                                         5- move(src,dst) :           move(cut) file from src to dst
Written By RX
