...
UserSfx= ['Tak','hichkas','weeed','.pk','.tkd','iw','wn','star','comp','love','rll','dark','black','off','coder','hacker','tm','teh','tehrun','Pishro','CR7','oficial','x']
UserPrfx=['alef','Injaneb','I','its','Im']
SpclChar=['_','.',]
...
#Email
pyautogui.click(828,368)
pyautogui.typewrite(FrstNm + LstNm + str(random.randint(100,9999)), interval=0.25)
pyautogui.typewrite('@mailfa.com', interval=0.25)


#Fullname
pyautogui.click(828,414)
...
pyautogui.click(828,462)
def GnrtUsrNm():
    UserNmTp= str(random.randint(1,11))
    if UserNmTp == '1' or UserNmTp == '2' or UserNmTp == '3':     #FrstLst9999
        pyautogui.typewrite(FrstNm + LstNm + str(random.randint(100,9999)), interval=0.25)
    elif UserNmTp == '4' or UserNmTp == '5' or UserNmTp == '6':     #FrstLst_9999
