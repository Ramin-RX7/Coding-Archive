...
start_maximized = True # better for repl.it and Trinket
...
def main_window(settings):
    ...
    col2 = sg.Column([[sg.Multiline(default_text=settings['out'], font=('Consolas', 10), key='_OUT_', autoscroll=True, size=(elem_width,2))]])
...
def about_me():
    sg.popup('TextCodeEditor is a PySimpleGUI based text and code')
