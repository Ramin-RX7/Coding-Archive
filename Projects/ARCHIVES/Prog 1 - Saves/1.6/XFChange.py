...
if WC== '1':
    ...
    if NP == CNP and len(NP) >= 8:
        ...
        ope = open(PyLib + 'XFInfo.py', mode= 'w')
    ...
    if os.path.exists('C:\\Users\\DELL\\AppData\\Local\\Programs\\Python\\Python37\\Lib\\XFSVNOM.py') == True:
        os.remove('C:\\Users\\DELL\\AppData\\Local\\Programs\\Python\\Python37\\Lib\\XFSVNOM.py')
        
    if os.path.exists('C:\\Users\\DELL\\AppData\\Local\\Programs\\Python\\Python37\\Lib\\XFSVTXT.py') == True:
        os.remove('C:\\Users\\DELL\\AppData\\Local\\Programs\\Python\\Python37\\Lib\\XFSVTXT.py')
        
    if os.path.exists('C:\\RIP\\Programs\\Saves\\XFForm.py') == True:
        os.remove('C:\\RIP\\Programs\\Saves\\XFForm.py')
        
    if os.path.exists('C:\\RIP\\Programs\\Saves\\XFLogin.py') == True:
        os.remove('C:\\RIP\\Programs\\Saves\\XFLogin.py')
    
    if os.path.exists('C:\\RIP\\Programs\\Saves\\') == True:
        os.rmdir('C:\\RIP\\Programs\\Saves\\')
