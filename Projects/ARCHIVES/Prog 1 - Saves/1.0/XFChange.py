...
if WC== '1':
    ...
    if NP == CNP and len(NP) >= 8:
        ...
        ope = open('C:\\Users\\DELL\\AppData\\Local\\Programs\\Python\\Python37\\Lib' + '\\' +'XFInfo.py', mode= 'w')
    ...
    os.path.exists('C:\\RIP\\Programs\\Saves\\XFForm.py') == True
        os.remove('C:\\RIP\\Programs\\Saves\\XFForm.py')
        
    os.path.exists('C:\\RIP\\Programs\\Saves\\XFLogin.py') == True
        os.remove('C:\\RIP\\Programs\\Saves\\XFLogin.py')
    
    os.path.exists('C:\\RIP\\Programs\\Saves\\') == True
