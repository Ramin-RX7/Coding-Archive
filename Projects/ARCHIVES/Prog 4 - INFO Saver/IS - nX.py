...
90- Clear Data \n91- Data\n\n''')
    ...
    if MC=='21':
        ...
        if IP_Pack == '1':
            ...
            print("This Computer IP Address is:" + IPAddr + 'now')
        ...
        MacAdrsRdd= MacAdrsRd.read()
        MacAdrsOp = open(".\\MacAddress\\Address.txt", mode= 'w')
        MacAdrsOp.write(MacAdrsRdd + Hostname + MacIF + '  -  ' + MacF + '\n')
        MacAdrsOp.close()         
        """import re, uuid  
        ...
        if DnT== '1':
            ...
            if LTCh == '1':
                ...
                TxtFrPsdDs= ('\nfrom ' + str(f_date) + ' until ' + str(l_date) + ' are/is ' + str(delta.days) + ' day(s)!')
                print(TxtFrPsdDs)
                DsPsdRd = open(".\\Date_Time\\Passed_Days\\Passed.txt", mode= 'r')
                DsPsdRdd= DsPsdRd.read()
                DsPsdOp = open(".\\Date_Time\\Passed_Days\\Passed.txt", mode= 'w')
                DsPsdOp.write(DsPsdRdd + '\n' + TxtFrPsdDs)
                DsPsdOp.close()
        ...
        def AddProg_Dl2Lst(Prog_Name, Category):
            ...
            AdProg2LstOp.write(AdProg2LstRdd+'In '+dt_string+' -  '+Category+':        '+Prog_Name+'  Was downloaded in '+Hostname+'.\n')
            AdProg2LstOp.close()
            pass
