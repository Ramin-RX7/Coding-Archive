...
def select_team():
    ...
    checker2 = True
    checker = None
    teams = {'BARCELONA':barcelona,'MADRID':madrid,'VALENCIA':valencia,'ATLETICO MADRID':amadrid,'SEVILLA':sevilla,'MANCHESTER CITY':manc,'MANCHESTER UNITED':manu,'CHELSEA':chelsea,'TOTTENHAM':tottenham,'LIVERPOOL':liverpool,'ARSENAL':arsenal,'NAPOLI':napoli,'JUVENTUS':juventus,'INTER MILAN':inter,'AS ROMA':roma,'LAZIO':lazlo}
